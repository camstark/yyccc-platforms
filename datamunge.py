...
platforms['position'] = platforms['office'].str.contains('Ward')
platforms['position'] = platforms['position'].replace({True:'councillor', False:'mayor'})
...
platforms = platforms[['position','office','name','incumbent','meta','platform']]
